...
TDConfig.SkinPath = TDConfig.BasePath + 'js/' ;
...
TDConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','OrderedList','UnorderedList','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Link','Unlink','-','FontName','FontSize','TextColor','-','Image','Flash','Source']
] ;
...
TDConfig.FontNames		= '宋体;新宋体;仿宋体;黑体;楷体;隶书;幼圆;Arial;Comic Sans MS;Courier New;Fixedsys;Georgia;Tahoma;Times New Roman;' ;
TDConfig.FontSizes = 'xx-small;x-small;small;medium;large;x-large;xx-large';
